...
class AllOrNothingIfNeededActionTest {

    private static final URI ENDPOINT = URI.create("/endpoint");
    private static final String ACTION = "ACTION";
    private final Action action = new AllOrNothingIfNeededAction(ACTION, HTTP_CLIENT, ENDPOINT);
    ...
    @Test
    void shouldOnlyPostItemsWithData() {
        Batch input = batchOf("001", "002", "003").withData(ACTION, "ABC", null, "GHI").build();
        ...
        assertThat(result)
            ...
            .itemsSatisfyExactlyInAnyOrder(
                ...
                singleResult(withSkipped(ACTION)),
                singleResult(withSuccess(ACTION))
            );
    }
